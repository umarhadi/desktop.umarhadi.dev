"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[2014,2482],{22014:function(e,t,n){n.r(t),n.d(t,{default:function(){return U}});var r=n(11527),o=n(45684),i=n(99122);var a=i.ZP.div.withConfig({componentId:"sc-4b72021-0"})`
...
`,F=n(56370);var U=e=>{let{id:t}=e;const{icon:n,title:o,processes:{[t]:i},url:a}=(0,u.z)(),{componentWindow:s,closing:c,icon:p="",url:g=""}=i||{},{fs:x,rootFs:m}=(0,A.o)(),[b,v]=(0,l.useState)(g),C=(0,l.useRef)(null),k=(0,d.basename)(g),E=Boolean(m?.mntMap[g]&&k),S=(0,l.useCallback)((e=>{e.altKey&&"D"===e.key.toUpperCase()&&((0,f.nK)(e),C?.current?.focus(h.eS))}),[]);return(0,l.useEffect)((()=>{g&&(o(t,k||h.SP),(!p||g!==b||E&&p!==h.iR)&&(E?n(t,"FileSystemAccess"===m?.mntMap[g].getName()?h.iR:h.Wc):x&&(n(t,`/System/Icons/${k?"folder":"pc"}.webp`),(0,w.nR)(x,g).then((e=>{e&&n(t,e)}))),v(g)))}),[b,k,x,p,t,E,m?.mntMap,n,a,o,g]),(0,l.useEffect)((()=>{!s||c||g||(a(t,"/"),n(t,"/System/Icons/pc.webp"))}),[c,t,s,n,a,g]),(0,l.useEffect)((()=>(s?.addEventListener("keydown",S),()=>s?.removeEventListener("keydown",S))),[s,S]),g?(0,r.jsxs)(M,{children:[(0,r.jsx)(B,{ref:C,hideSearch:E,id:t}),(0,r.jsx)(F.Z,{id:t,url:g,view:"icon",showStatusBar:!0})]}):null}},2482:function(e,t,n){n.r(t);const r=n(99122).ZP.div.withConfig({componentId:"sc-29e5eb62-0"})`
  cursor: wait;
  height: 100%;
  width: 100%;
